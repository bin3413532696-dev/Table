...
exports.defaultMessageManager = exports.MessageManager = void 0;
/**
 * 消息记忆管理器
 *
...
class MessageManager {
     ...
     */
    async estimateTokenCount(messages) {
    ...
    async trim(messages) {
        ...
        // 使用 trimMessages 修剪
        try {
            return await (0, messages_1.trimMessages)(messages, {
     ...
     */
    static fromProviderConfig(provider, model) {
        // 不同模型有不同的上下文限制
        const contextLimits = {
            // GPT-4o 系列
            'gpt-4o': 128000,
...
// 创建默认实例
exports.defaultMessageManager = new MessageManager();
